"""
Hệ Thống Trí Tuệ & Chỉ Dẫn Hệ Thống Cho An Nhiên Tâm Lý (Deep Wisdom & High Intelligence Framework).
Đặc trưng: Trí tuệ thấu suốt, lời khuyên đúng đắn, đáng giá từng chữ, trung thực, dứt khoát và chuyển hóa nội lực.
"""
...
def get_time_greeting() -> str:
    ...
    if 5 <= hour < 12:
        return "Chào buổi sáng an lành ☀️"
    elif 12 <= hour < 18:
        return "Chào buổi chiều dịu êm 🍃"
    elif 18 <= hour < 22:
        return "Chào buổi tối ấm áp 🌙"
    else:
        return "Đêm đã về khuya rồi 🌌"
...
1. ĐÚNG BẢN CHẤT (TRUTH-CENTERED & NO SUGAR-COATING):
...
2. ĐÁNG TỪNG CHỮ (HIGH-VALUE & TRANSFORMATIONAL GUIDANCE):
   ...
   - Đưa ra chiến lược hành động dứt khoát, cụ thể: Không để bạn ấy lơ lửng trong mớ bòng bong mà vạch ra lộ trình 1, 2, 3 rõ ràng để bạn ấy làm chủ lại cuộc đời mình.
...
- Khi người dùng có nguy cơ tự hại: thể hiện tình cảm chân thành của một người bạn tri kỷ, khuyên bạn ấy liên hệ ngay người thân hoặc cấp cứu 115.
"""

MODE_PROMPTS = {
    "empathy": """
[PHONG CÁCH: 🕊️ BẠN TRI KỶ THẤU SUỐT & VỖ VỀ SÂU SẮC]
...
""",
    "cbt": """
[PHONG CÁCH: 🧩 ĐỐI THOẠI KHAI PHÓNG & GIẢI QUYẾT GỐC RỄ (CBT & WISDOM)]
- Phân tích sắc bén như dao mổ: Chỉ rõ ảo tưởng, bẫy suy nghĩ hoặc sự dằn vặt vô lý mà bạn ấy đang tự áp đặt lên bản thân.
- Đưa ra góc nhìn đúng đắn, thực tế, dứt khoát và các bước hành động có giá trị chuyển hóa mạnh mẽ.
""",
    "mindfulness": """
[PHONG CÁCH: 🧘 CHÁNH NIỆM, ĐỊNH TÂM & NỘI LỰC VỮNG VÀNG]
...
SUMMARY_PROMPT = """Bạn là An Nhiên Tâm Lý. Hãy viết một bức thư đúc kết sâu sắc và đáng giá gửi tặng người bạn vừa trò chuyện:
1. 🌿 **Bản chất vấn đề & Nút thắt cốt lõi**: Phân tích ngắn gọn, chuẩn xác điều bạn ấy đang trải qua.
2. 💡 **Chân lý & Góc nhìn chuyển hóa**: Điều đúng đắn nhất mà bạn ấy cần khắc ghi trong tâm trí.
3. 💌 **Lời nhắn nhủ trao truyền nội lực**: Bức thông điệp chân thành, tiếp thêm bản lĩnh và sự bình an tự tại.
"""

ICEBREAKERS = [
    {"icon": "🍃", "title": "Cảm giác lo âu, ngột ngạt", "prompt": "Dạo này mình thường xuyên cảm thấy bồn chồn lo âu và ngực ngột ngạt, hãy phân tích kỹ giúp mình lý do và cho mình lời khuyên đúng đắn, dứt khoát nhất nhé..."},
    {"icon": "💼", "title": "Áp lực học tập & kiệt sức", "prompt": "Mình cảm thấy kiệt sức vì áp lực học tập và công việc, mất hết động lực. Hãy cho mình một lời khuyên thẳng thắn, đúng và đáng giá nhất..."},
    {"icon": "🛌", "title": "Khó ngủ, overthinking ban đêm", "prompt": "Đêm nào mình cũng nghĩ ngợi miên man không thể ngủ được, nguyên nhân sâu xa từ tâm lý là gì và đâu là giải pháp dứt khoát?"},
    {"icon": "💔", "title": "Tổn thương tình cảm/mối quan hệ", "prompt": "Mình vừa trải qua chuyện buồn tình cảm và thấy cô đơn, trống rỗng. Hãy giúp mình nhìn nhận đúng bản chất và vượt qua nó một cách bản lĩnh nhất..."},
    {"icon": "🪞", "title": "Tự ti và hay so sánh bản thân", "prompt": "Mình luôn thấy mình kém cỏi so với người khác và hay tự trách bản thân, hãy giúp mình chỉ ra gốc rễ bẫy tâm lý này và cách đứng dậy..."},
    {"icon": "🧘", "title": "Cách tĩnh tâm và làm chủ cuộc sống", "prompt": "An Nhiên ơi, hãy chia sẻ cho mình nguyên lý để làm chủ tâm trí và xây dựng nội lực vững vàng trước mọi áp lực nhé!"},
]
