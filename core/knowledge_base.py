"""
Cơ sở dữ liệu kiến thức giáo dục tâm lý (Psychoeducation), bẫy tư duy CBT và bộ câu hỏi trắc nghiệm.
"""
...
COGNITIVE_DISTORTIONS = [
    {
        ...
        "example": "'Nếu mình không đạt điểm A môn này, mình là kẻ vô dụng hoàn toàn.'",
    ...
    },
    {
        ...
        "example": "'Mình cảm thấy mình ngu ngốc, vậy nên mình thật sự là người kém cỏi.'",
...
PSYCHOEDU_ARTICLES = [
    {
        ...
        "readTime": "3 phút",
        "summary": "Hiểu rõ mối quan hệ mật thiết giữa Suy nghĩ ➡️ Cảm xúc ➡️ Hành vi để làm chủ tâm trạng.",
        "content": """
...
> 💡 **Quy luật chuyển động**: Khi bạn thay đổi **Suy nghĩ** thành góc nhìn thực tế và tích cực hơn, **Cảm xúc** sẽ dịu đi và **Hành vi** sẽ trở nên hiệu quả hơn!
"""
    },
    {
        "id": "study_stress_coping",
        "title": "Cẩm Nang Quản Lý Stress Học Đường & Thi Cử",
...
1. **Phân biệt Áp lực lành mạnh (Eustress) & Áp lực kiệt sức (Distress)**:
   ...
   - Nhưng khi tim đập nhanh kéo dài, mất ngủ và sợ hãi, cơ thể đang báo động đỏ kiệt sức.
...
3. **Tách Biệt Điểm Số & Giá Trị Bản Thân**:
   - Điểm số chỉ phản ánh mức độ nắm kiến thức ở một thời điểm, không phản ánh trí tuệ hay phẩm giá của bạn.
"""
    },
    {
        "id": "panic_and_overthinking",
        "title": "Hiểu Về Cơ Chế Overthinking & Lo Âu",
        "category": "Sức Khỏe Tinh Thần",
        "readTime": "3 phút",
        "summary": "Tại sao não bộ lại liên tục nghĩ ngợi vào ban đêm và cách ngắt mạch suy nghĩ lặp lại.",
        "content": """
### 🧠 Não Bộ Hoạt Động Thế Nào Khi Bạn Overthinking?
Hạch hạnh nhân (Amygdala) - trung tâm cảnh báo nguy hiểm trong não - bị kích hoạt quá mức, khiến não hiểu nhầm các suy nghĩ tưởng tượng là mối đe dọa sinh tử thực tế.

**3 Bước Ngắt Mạch Overthinking:**
1. **Ghi nhận**: Tự nhủ 'À, tâm trí mình lại đang bật chế độ lo xa rồi.'
2. **Kỹ thuật 5-4-3-2-1**: Đưa sự chú ý về các giác quan thực tại ngay xung quanh.
3. **Viết xả (Brain Dump)**: Viết toàn bộ suy nghĩ trong đầu ra một tờ giấy rồi gấp lại, hẹn sáng mai sẽ xem xét.
"""
    }
]
...
ASSESSMENT_QUIZZES = {
    "gad7": {
        "title": "Trắc Nghiệm Đánh Giá Mức Độ Lo Âu & Áp Lực",
        "subtitle": "Dựa trên thang đo chuẩn hóa GAD-7 (Generalized Anxiety Disorder)",
        ...
        "brackets": [
            {
                ...
                "color": "#10B981",
                "advice": "Tâm lý của bạn đang ở trạng thái ổn định và cân bằng. Hãy tiếp tục duy trì lối sống lành mạnh, ăn ngủ điều độ và dành thời gian cho sở thích cá nhân nhé!"
            },
            {
                "range": (5, 9),
                "level": "Mức độ Lo âu Nhẹ",
                "color": "#F59E0B",
                "advice": "Bạn đang có một chút áp lực và bồn chồn. Hãy thử áp dụng bài tập thở 4-7-8, giảm bớt caffeine và chia sẻ với An Nhiên hoặc bạn bè thân thiết."
            },
            {
                "range": (10, 14),
                "level": "Mức độ Lo âu Trung bình",
                "color": "#F97316",
                "advice": "Mức độ căng thẳng đang ảnh hưởng rõ rệt đến chất lượng cuộc sống và học tập. Hãy dành nhiều thời gian hơn để nghỉ ngơi, thực hành chánh niệm và trò chuyện cùng An Nhiên để tháo gỡ từng vấn đề."
            },
            {
                "range": (15, 21),
